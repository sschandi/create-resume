    ...
    <Layout fluid={true}>
      ...
      <section className="jumbotron">
        <div className="jumbotron--container">
          ...
          <Link href="/app">
            <button className="btn btn-link btn-primary btn-lg">Go To App</button>
          </Link>
        </div>
      ...
      <section className="features simple container">
        ...
        <div className="simple__image simple__image--right">
          <img src={TeresImg.src} alt="Sample Resume" />
        </div>
      </section>
      <section className="features free container">
        ...
        <div className="free__content feature__content">
          ...
          <div className="free__content--text">
            ...
            <Link href="/app">
              <button className="btn btn-link btn-primary">Create Your Resume</button>
            </Link>
          </div>
        </div>
      </section>
